...
export class StudentComponent {
  ...
  AllStudent: Student[] = [
    new Student(1, "Rachely", 18, "Rabbi Akiva", new Date(), true,false),
    new Student(2, "Nachama", 25, "Yavne", new Date(), true,false),
    new Student(3, "Lea", 14.5, "???", new Date(), true,false),
    new Student(4, "Lea", 14.5, "???", new Date(), true,true),
    new Student(5, "Lea", 14.5, "???", new Date(), true,true),
    new Student(6, "Lea", 14.5, "???", new Date(), true,true),
